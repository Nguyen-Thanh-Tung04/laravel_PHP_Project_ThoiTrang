            ...
            <div class="container">
                <div class="row flex-sm-row-reverse">
                    ...
                    <div class="col-md-6 text-start">
                        <p class="copy-text"> © 2024 <i class="ion-heart" aria-hidden="true"></i> By <a class="company-name" href="https://hasthemes.com/">
                                <strong> Nguyen_Thanh_Tung</strong></a>.</p>
                    </div>
                </div>
            </div>
        </div>
...
<script src="{{asset('theme/client/assets/js/sweetalert2.all.min.js')}}"></script>
